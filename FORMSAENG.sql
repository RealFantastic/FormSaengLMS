...
--수정
update WEEK_LECTURE set WEEK_NO = 2203 WHERE VIDEO_TITLE = 'asdasf';
update WEEK_LECTURE set VIDEO_TITLE = 'JAVA심화1' where lecture_no = 2;
update WEEK_LECTURE set FILE_PATH = '/pf/week/view';
alter table "COMMENT" rename to ASSIGNMENT_COMMENT;

--코멘트 값 입력
insert into "COMMENT" values (1,'윤영원',default,'안녕하세요','S2022954112',14);

ALTER TABLE ASSIGNMENT_FILE ADD (BOARD_ASSIGNMENT_NO NUMBER);

ALTER TABLE ASSIGNMENT_FILE ADD CONSTRAINT FK_ASG_LIST_TO_ASGFILE_1
FOREIGN KEY (BOARD_ASSIGNMENT_NO)
REFERENCES ASSIGNMENT_LIST (BOARD_ASSIGNMENT_NO);
ALTER TABLE ASSIGNMENT_FILE MODIFY BOARD_ASSIGNMENT_NO NOT NULL;
ALTER TABLE ASSIGNMENT_FILE DROP COLUMN COMMENT_NO;
ALTER TABLE ASSIGNMENT_FILE ADD (ID VARCHAR2(12) NOT NULL);

ALTER TABLE ASSIGNMENT_FILE ADD CONSTRAINT FK_MEMBER_TO_ASGFILE_1
FOREIGN KEY (ID)
REFERENCES MEMBER (ID);

ALTER TABLE ASSIGNMENT_FILE DROP COLUMN id;

truncate table ASSIGNMENT_FILE;

ALTER TABLE ASSIGNMENT_FILE ADD (COMMENT_NO number NOT NULL); 

ALTER TABLE "ASSIGNMENT_FILE" ADD CONSTRAINT "FK_COMMENT_TO_ASG_FILE_1" FOREIGN KEY (
	"COMMENT_NO"
)
REFERENCES "ASSIGNMENT_COMMENT" (
	"COMMENT_NO"
);

ALTER TABLE "ASSIGNMENT_FILE" DROP CONSTRAINT "FK_COMMENT_TO_ASG_FILE_1";
...
ALTER TABLE ENROLLMENT_STUDENT DROP CONSTRAINT FK_SUBJECT_TO_ENROLL_ST_1;
ALTER TABLE ENROLLMENT_STUDENT ADD CONSTRAINT FK_SUBJECT_TO_ENROLL_ST_1 FOREIGN KEY
(SUBJECT_CODE) REFERENCES SUBJECT(SUBJECT_CODE) ON DELETE CASCADE;
...
alter table "WEEK_LECTURE" disable constraint "FK_SUBJECT_TO_WEEK_LECTURE_1";

ALTER TABLE WEEK_LECTURE DISABLE PRIMARY KEY CASCADE;

truncate table WEEK_LECTURE;

ALTER TABLE WEEK_LECTURE ENABLE PRIMARY KEY;

alter table "WEEK_LECTURE" enable constraint "FK_SUBJECT_TO_WEEK_LECTURE_1";
...
alter table "ASSIGNMENT_LIST" disable constraint "FK_MEMBER_TO_ASG_LIST_1";

ALTER TABLE ASSIGNMENT_LIST DISABLE PRIMARY KEY CASCADE;

truncate table ASSIGNMENT_LIST;

ALTER TABLE ASSIGNMENT_LIST ENABLE PRIMARY KEY;

alter table "ASSIGNMENT_LIST" enable constraint "FK_MEMBER_TO_ASG_LIST_1";
