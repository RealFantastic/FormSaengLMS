...
<%-- 					<img class="logo2" src="<%=request.getContextPath()%>/resources/images/fromsaenglogo.png" alt="폼생대로고" class="fromsaenglogo"> --%>
<!-- 				</a> -->
<%-- 				<a href="<%=request.getContextPath()%>/mg/main"> --%>
<%-- 					<img class="logo1" src="<%=request.getContextPath()%>/resources/images/name_logo.png" alt="폼생대학교"> --%>
<!-- 				</a> -->
			</div>
