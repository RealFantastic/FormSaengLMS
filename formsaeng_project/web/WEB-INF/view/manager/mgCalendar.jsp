...
<head>
    ...
    //일정속성
    	document.addEventListener('DOMContentLoaded', function() {
     	//var calendarEl = document.get document.getElementById('calendar');
     	var calendar = new FullCalendar.Calendar(calendarEl,{
    		timeZone:'UTC',
    		initialView:'dayGridMonth', //홈페이지에서 다른 형태의 view를 확인
     		
    		events:[
    			{
    				title:'all day event',
    				start: '2022-04-28 00:00:00',
    				end:'2022-04-29 24:00:00'
    			}
     		], headerToolbar:{
