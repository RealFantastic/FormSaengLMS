...
<link rel="stylesheet" href="<%= request.getContextPath() %>/resources/css/pfAsgBoardView.css">
		...
		<div class="template_container">
			...
			<div class="content_container">
				...
				<div class="body_div">
					...
					<div class="view-btn">
						<button type="button" id="asg_modify" class="btn btn-secondary">수정</button>
...
<%-- 							<input type="hidden" id="cNo" value="${avo.cNo }"> --%>
									...
									<td class="th-cmt-tb"><a href="<%=request.getContextPath()%>/pf/asgboard/read/down?file=${avo.fName}">${avo.fName }</a></td>
									<td>
  ...
  $(".delCmt-btn").click(function(){
	 	...
	 	console.log(cNo);
	 		$.ajax({
	 			url : "<%=request.getContextPath()%>/pf/asgboard/read/delete.ax",
	 			type : "post",
	 			data : { cNo : cNo },
	 			dataType : "json",
	 			success : function(result){
