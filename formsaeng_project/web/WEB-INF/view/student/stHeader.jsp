  ...
  <% MemberVo ssvo = (MemberVo) request.getSession().getAttribute("ssMemberVo"); %>
    <div class="side_container">
      ...
      <ul class="list_button">
        ...
        <li>
          <a href="<%=request.getContextPath()%>/st/message">
        ...
        <li>
          <a href="<%=request.getContextPath()%>/st/SubjectList">
        ...
        <li>
          <a href="<%=request.getContextPath()%>/st/calendar"> 
      ...
      <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
        <li><a class="dropdown-item" style="padding-top:2px; margin-bottom:1px;" href="<%=request.getContextPath()%>/st/mypage">마이페이지</a></li>
        <li><hr class="dropdown-divider" style="margin:1px;"></li>
        <li><a class="dropdown-item" href="<%=request.getContextPath()%>/stlogout">로그아웃</a></li>
      </ul>
    </div>
  </div>
  </header>