package kh.semi.lms.lectureboard.vo;
...
public class LectureBoardVo {
	...
	public LectureBoardVo() {
		super();
	}
	public LectureBoardVo(int lbAno, String lbATitle, String lbAContent, String lbAWriter, String lbADate, String lbAcode, String lbACode) {
		super();
		this.lbAno = lbAno;
