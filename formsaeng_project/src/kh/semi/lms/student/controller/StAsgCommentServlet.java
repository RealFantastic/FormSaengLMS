...
/**
 * Servlet implementation class StAsgCommentServlet
 */
@WebServlet("/st/asgboard/read/comment")
public class StAsgCommentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StAsgCommentServlet() {
        super();
...
//	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("dopost 삭제하러 들어왔는가?");
