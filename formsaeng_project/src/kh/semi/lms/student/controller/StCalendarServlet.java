...
/**
 * Servlet implementation class StCalendarServlet
 */
@WebServlet("/st/calendar")
public class StCalendarServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StCalendarServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("doGet : /st/calendar" );
		...
		request.getRequestDispatcher("/WEB-INF/view/student/stCalendar.jsp").forward(request, response);
