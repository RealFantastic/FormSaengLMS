...
/**
 * Servlet implementation class StAsgCommentDownloadServlet
 */
@WebServlet("/st/asgboard/read/down")
public class StAsgCommentDownloadServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StAsgCommentDownloadServlet() {
        super();
