...
/**
 * Servlet implementation class StAsgListReadServlet
 */
@WebServlet("/st/asgboard/read")
public class StAsgListReadServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StAsgListReadServlet() {
        super();
...
//		ArrayList<AsgCommentVo> readBoardAndComments = new AsgListService().readBoardAndComments(avo);
		...
		if(readBoard != null) {
			...
			request.getRequestDispatcher("/WEB-INF/view/student/st_readasgboard.jsp").forward(request, response);
		}
	}
