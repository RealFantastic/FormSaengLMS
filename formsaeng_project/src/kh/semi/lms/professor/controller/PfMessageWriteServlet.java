...
/**
 * Servlet implementation class PfMessageWriteServlet
 */
@WebServlet("/pf/msgwrite")
public class PfMessageWriteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PfMessageWriteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("doGet/pfmsgwrite");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("doPost/pfmsgwrite");
...
//		String recevier=request.getParameter("recevier");
		...
		if(result==0) {
			...
			response.sendRedirect(request.getContextPath()+"/pf/message");
		}
	}
