...
/**
 * Servlet implementation class PfMessageRecipientServlet
 */
@WebServlet("/pf/recipient.ax")
public class PfMessageRecipientServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PfMessageRecipientServlet() {
        super();
