...
/**
 * Servlet implementation class MgMessageRecipientServlet
 */
@WebServlet("/mg/recipient.ax")
public class MgMessageRecipientServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MgMessageRecipientServlet() {
        super();
